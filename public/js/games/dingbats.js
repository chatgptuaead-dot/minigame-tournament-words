...
class DingbatsGame {
  ...
  _buildMobileControls() {
    ...
    goBtn.style.cssText = 'padding:18px 22px;background:linear-gradient(135deg,rgba(0,212,255,0.4),rgba(123,47,255,0.4));border:2px solid #00d4ff;color:#fff;border-radius:14px;font-size:18px;font-family:"Orbitron",sans-serif;font-weight:900;cursor:pointer;white-space:nowrap;flex-shrink:0;letter-spacing:1px;-webkit-tap-highlight-color:transparent;touch-action:manipulation;';
