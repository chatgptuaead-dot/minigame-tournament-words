...
const DINGBATS_ITEMS = [
  { visual: 'STAND\nI', answer: 'I UNDERSTAND', hint: 'I is below STAND' },
  { visual: 'WEAR\nLONG', answer: 'LONG UNDERWEAR', hint: 'LONG is under WEAR' },
  { visual: 'EGGS\nEGGS\nEGGS\nEGGS\nEGGS\nEGGS', answer: 'HALF A DOZEN EGGS', hint: 'Count the rows' },
  { visual: 'BAN ANA', answer: 'BANANA SPLIT', hint: 'The word is split with a space' },
  { visual: 'MIND\nMATTER', answer: 'MIND OVER MATTER', hint: 'MIND is above MATTER' },
  { visual: 'DEATH/LIFE', answer: 'LIFE AFTER DEATH', hint: 'LIFE comes after DEATH in the phrase' },
  { visual: 'BLACK\nBLUE', answer: 'BLACK AND BLUE', hint: 'Two colors — what joins them?' },
  { visual: 'HEAD\n----\nHEELS', answer: 'HEAD OVER HEELS', hint: 'HEAD is over the line and HEELS' },
  { visual: 'HIS\nSTORY', answer: 'HISTORY', hint: 'Combine the two words' },
  { visual: 'NOON\nGOOD', answer: 'GOOD AFTERNOON', hint: 'GOOD + AFTER + NOON' },
  { visual: 'CC\nCC', answer: 'FOUR CORNERS', hint: 'Four Cs in the corners' },
  { visual: 'MILONEI', answer: 'ONE IN A MILLION', hint: 'ONE is hidden inside the word' },
  { visual: 'CYCLE\nCYCLE\nCYCLE', answer: 'TRICYCLE', hint: 'How many cycles are shown?' },
  { visual: 'BELT\nHIT', answer: 'HIT BELOW THE BELT', hint: 'HIT is below BELT' },
  { visual: 'POD\nO O O', answer: 'THREE PEAS IN A POD', hint: 'Count the circles under the pod' },
  { visual: 'GROUND\nFEET\nFEET\nFEET\nFEET\nFEET\nFEET', answer: 'SIX FEET UNDERGROUND', hint: 'Count the FEET rows' },
  { visual: 'MAN\nBOARD', answer: 'MAN OVERBOARD', hint: 'MAN is above the BOARD' },
  { visual: 'R  E  A  D', answer: 'READ BETWEEN THE LINES', hint: 'Look at what is between the letters' },
  { visual: 'I  O  U', answer: 'I OWE YOU', hint: 'Say each letter phonetically' },
  { visual: 'KNEE\nLIGHT', answer: 'NEON LIGHT', hint: 'KNEE sounds like N + E' },
  { visual: 'JACK\nBOX', answer: 'JACK IN THE BOX', hint: 'JACK is above BOX' },
  { visual: 'SIDE  SIDE', answer: 'SIDE BY SIDE', hint: 'Two SIDEs sitting next to each other' },
  { visual: 'OVER\nSEAS', answer: 'OVERSEAS', hint: 'SEAS is under OVER' },
  { visual: 'OVER\nWHELM', answer: 'OVERWHELM', hint: 'WHELM is under OVER' },
  { visual: 'FOOT\nNOTE', answer: 'FOOTNOTE', hint: 'NOTE is under FOOT' },
  { visual: 'LI\nFE', answer: 'HALF LIFE', hint: 'LIFE is split right down the middle' },
  { visual: 'ALL\n IN\nALL', answer: 'ALL IN ALL', hint: 'Read from top to bottom' },
  { visual: 'WATER\nFALL', answer: 'WATERFALL', hint: 'FALL is under WATER' },
];
